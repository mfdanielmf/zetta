...
const { value: contraseña_repetir } = useField("contraseña_repetir", undefined, {initialValue: ""})
  ...
  <div :class="cn('flex flex-col gap-6', props.class)">
    <form @submit="onSubmit">
      <FieldGroup>
        ...
        <Field>
          <FieldLabel for="contraseña-repetir">
            Repetir Contraseña*
          </FieldLabel>
          <Input
