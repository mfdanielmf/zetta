...
import { Download, Ellipsis, Folder, SearchIcon, Share2, Star, Trash2 } from 'lucide-vue-next'
...
const { data: dataItems, isLoading: loadingItems } = useGetFavoriteItems(
  pagina,
  limite,
  busquedaDebounced,
)
  ...
  <div class="space-y-2">
    ...
    <Table>
      <TableCaption v-if="loadingItems || noData">
        {{ loadingItems ? 'Cargando...' : 'Tus archivos y carpetas favoritos se mostrarán aquí.' }}
      </TableCaption>
      ...
      <TableHeader class="bg-neutral-100">
        <TableRow>
          ...
          <TableHead>Fecha Favorito</TableHead>
