...
def test_archivos_recibidos_success():
    ...
    with patch("app.routes.shared_routes.shared_file_services.obtener_archivos_recibidos") as mock_recibidos:
        mock_recibidos.return_value = [archivo_compartido]

        response = client.get("/api/shared/received/files")
